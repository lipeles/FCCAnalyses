...
if version=='private':
    ...
    process_list = {
        ...
        # # If you want to process only part of the events, split the output into chunks or give a different name to the output use the optional arguments
        # # or leave blank to use defaults = run the full statistics in one output file named the same as the process:
        'mgp8_pp_vbf_h01j_5f_hwwlvlv' : { 'fraction': fraction, 'chunks' : int(20*fraction) },
        'mgp8_pp_tt012j_5f_blvblv' : { 'fraction' : fraction, 'chunks' : int(200*fraction)},
        'mgp8_pp_z0123j_4f_ztautau' : { 'fraction' : fraction, 'chunks': int(30*fraction)},  
        'mgp8_pp_vbf_ww_lvlv_5f_noHiggs_100TeV' :  { 'fraction' : fraction, 'chunks': int(10*fraction)}, 
    }
...
print("stage1_output",stage1_output)
print("final_output",final_output)
print("plots_output",plots_output)
print()